...
import { faBook, faSpinner, faExclamationTriangle, faTimesCircle } from '@fortawesome/free-solid-svg-icons';
    ...
    >
      ...
      <div className="w-full">
        ...
        {!portfolio && !isLoading && !error && (
          <div className="text-center mt-10">
            <FontAwesomeIcon icon={faTimesCircle} className="text-4xl text-gray-500" />
